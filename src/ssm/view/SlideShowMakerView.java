...
public class SlideShowMakerView {
	...
	slideEditToolbar = new VBox();
        slideEditToolbar.setSpacing(35);
	...
	viewSlideShowButton.setOnAction(e -> {
            fileController.handleSaveSlideShowRequest();
            WebsiteView wv = new WebsiteView(slideShow.getTitle(), slideShow.getSize());
            try {
                CreateDirectory cd = new CreateDirectory(slideShow.getTitle(), slideShow.getSize(), slideShow.getSlides());
