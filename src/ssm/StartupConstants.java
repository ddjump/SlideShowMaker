...
public class StartupConstants {
    ...
    public static String ICON_YEN = "yen28.png";
    ...
    public static String    CSS_CLASS_LANG_PROMPT_BTN = "lang_prompt_BTN";
    public static String    CSS_CLASS_FONT_WORDS = "font_words";
